...
void MTRTimeSynchronizationTrustedTimeSourceListAttributeCallbackBridge::OnSuccessFn(void * context,
    ...
    if (value.IsNull()) {
        ...
        { // Scope for our temporary variables
            ...
            while (iter_1.Next()) {
                ...
                MTRTimeSynchronizationClusterTrustedTimeSourceStruct * newElement_1;
                newElement_1 = [MTRTimeSynchronizationClusterTrustedTimeSourceStruct new];
                newElement_1.fabricIndex = [NSNumber numberWithUnsignedChar:entry_1.fabricIndex];
                newElement_1.nodeID = [NSNumber numberWithUnsignedLongLong:entry_1.nodeID];
                newElement_1.endpoint = [NSNumber numberWithUnsignedShort:entry_1.endpoint];
...
void MTRTimeSynchronizationTrustedTimeSourceListAttributeCallbackSubscriptionBridge::OnSubscriptionEstablished()
{
    if (!mQueue) {
        return;
    }
    ...
    void * context, const chip::app::Clusters::TimeSynchronization::Commands::SetTimeZoneResponse::DecodableType & data)
{
    ...
    {
        response.dstOffsetRequired = [NSNumber numberWithBool:data.DSTOffsetRequired];
    }
    DispatchSuccess(context, response);
};
