 ...
 */
class TrustMPersistentStorageOperationalKeystore : public Crypto::OperationalKeystore
{
public:
    TrustMPersistentStorageOperationalKeystore() = default;
    virtual ~TrustMPersistentStorageOperationalKeystore() { Finish(); }

    // Non-copyable
    TrustMPersistentStorageOperationalKeystore(TrustMPersistentStorageOperationalKeystore const &) = delete;
    void operator=(TrustMPersistentStorageOperationalKeystore const &)                       = delete;
